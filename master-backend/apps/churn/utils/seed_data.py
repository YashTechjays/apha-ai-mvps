...
def generate_mock_members(n: int = 200):
    ...
    for _ in range(n):
        ...
        # Only include fields that exist as Member model columns
        valid_columns = {
            "days_since_last_login", "cpe_hours_last_90d", "cpe_hours_ytd",
            "email_open_rate_30d", "email_click_rate_30d", "events_attended_ytd",
            "events_registered_ytd", "publications_read_30d", "job_board_searches_30d",
            "community_posts_90d", "renewal_count", "years_as_member",
            "cpe_deadline_days", "benefits_used_pct",
        }
        members.append({
            ...
            "is_active": True,
            **{k: v for k, v in feats.items() if k in valid_columns},
        })
    return members
