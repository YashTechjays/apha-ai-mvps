...
with DAG(
    ...
    def task_pull_usage(**ctx):
        ...
        from apps.crosssell.pipeline.connectors.usage_connector import pull_all_product_usage
        db = SessionLocal()
        try:
    ...
    def task_send_nudges(**ctx):
        from apps.crosssell.nudge_engine.tasks import send_batch_email_nudges
