...
from apps.drug_ref.ai.clinical_assistant import get_assistant
from apps.drug_ref.api.deps import enforce_quota_and_rate_limit, get_current_user, get_db
from apps.drug_ref.api.schemas.query import (
    ChunkItem,
    CitationItem,
    FeedbackRequest,
    QueryRequest,
...
from apps.drug_ref.db.models import QueryLog, Subscription, User
