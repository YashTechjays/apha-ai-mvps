...
from apps.acquisition.api.schemas.salary import SalaryRequest, SalaryResponse
from apps.acquisition.ai.salary_engine import generate_salary_analysis
from apps.acquisition.rate_limiter.redis_limiter import check_limit
from core.logger import get_logger

router = APIRouter(prefix="/salary", tags=["acquisition-salary"])
