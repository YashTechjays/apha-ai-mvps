...
from apps.email_app.db.session import get_db
from apps.email_app.db.models.member import Member
from apps.email_app.db.models.email_send import EmailSend
from apps.email_app.api.schemas.email_send import EmailSendResponse, EmailPreviewResponse
from apps.email_app.ai.benefit_valuation import compute_benefit_summary
from apps.email_app.ai.email_generator import generate_email_content
from apps.email_app.email_delivery.template_renderer import render_html
from apps.email_app.scheduler.monthly_job import run_monthly_email_job, process_member_email
...
async def postmark_webhook(payload: dict, db: Session = Depends(get_db)):
    import uuid
    from apps.email_app.db.models.email_event import EmailEvent
