...
def trigger_nurture_sequence(lead: Lead):
...
def _salary_sequence(lead: Lead):
    """
...
def _interaction_sequence(lead: Lead):
    """
...
def _career_sequence(lead: Lead):
    """
...
def _generic_sequence(lead: Lead):
